      ...
      <b-col>
        <b-card-group deck>
          <b-card title="更新情報">
            ...
            <b-card-text class="mx-3">2021/03/11</b-card-text>
            <b-card-sub-title class="mb-2">サイト情報更新日</b-card-sub-title>
            <b-card-text class="mx-3">2021/03/14</b-card-text>
...
import rawdata from '@/assets/data20210311.json'
...
export default {
  ...
  data() {
    return {
      JSON_PATH: 'data/data20210311.json',
      arrObj: rawdata,
      arrObjDetailed: {},
